...
public class CashBook extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<link rel='stylesheet' href='Style28.css'>");
		out.println("</head>");
		out.println("<body>");
		...
		out.println("<div class='content'><br><br>");
				out.println("<h2>Cash<span>Book</span></h2>");
		out.println("<div class='cat'><form action='CashBook'>Date From<input type='date' name='sdate'><br>");
	...
	//	
		ArrayList<CashBookBean> al=ex.findAllDateWise(sdate,edate,userid);
		for(CashBookBean es:al ) {
		out.println("<tr>");
		out.println("<td>'"+i+++"'</td>");
